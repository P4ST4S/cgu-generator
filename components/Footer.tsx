...
export default function Footer() {
  ...
  return (
    <footer className="bg-foreground text-white py-12 px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="md:col-span-2">
            <Link href="/" className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-semibold">CGUgen</span>
            </Link>
            <p className="text-gray-400 leading-relaxed max-w-md">
              La solution moderne pour générer vos documents juridiques en quelques clics.
              Simple, rapide et conforme au RGPD.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="#demo" className="text-gray-400 hover:text-primary transition-colors">
                  Démo
                </Link>
              </li>
              <li>
        ...
        <div className="pt-8 border-t border-white/10">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-400 text-sm">
              © {currentYear} CGUgen – Tous droits réservés
            </p>
            <div className="flex items-center gap-6 text-sm">
              <Link href="/cookies" className="text-gray-400 hover:text-primary transition-colors">
                Gestion des cookies
              </Link>
              <Link href="/rgpd" className="text-gray-400 hover:text-primary transition-colors">
                RGPD
              </Link>
            </div>
          </div>
